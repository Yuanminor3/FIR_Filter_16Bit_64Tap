...
## Setting files/paths
set verilog_files {../../dc/fir_shift_imem/fir_shift_imem.nl.v}
set my_toplevel fir_shift_imem
...
## Run STA 
###################################################
set rpt_file "./fir_shift_imem_pt.rpt"
check_timing
...
read_vcd "../../qsim_dc/fir_shift_imem/fir_shift_imem.vcd" -strip_path "fir_shift_imem_tb/uut"
...
write_sdf -context verilog "./fir_alu.sdf"
