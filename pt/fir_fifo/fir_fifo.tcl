...
## Setting files/paths
set verilog_files {../../dc/fir_fifo/fir_fifo.nl.v}
set my_toplevel fir_fifo
...
read_vcd "../../qsim_dc/fir_fifo/fir_fifo.vcd" -strip_path "fifo_testbench/uut"
...
write_sdf -context verilog "./fir_fifo.sdf"
